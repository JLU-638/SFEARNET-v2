...
save_dir = 'logs/result/visCLCDIOU/'
...
if __name__ == '__main__':
    ...
    model = torch.load('logs/model_SFEARNet_data_CLCD_lr_0.0001_bs_8_wd_0.001_lam_1.0_ep_100_seed_0/run_2026-04-09_15-55-02/best_model/best_model.pth').to(device)

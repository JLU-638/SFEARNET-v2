...
def get_args():
    ...
    parser.add_argument('--beta', default=0.1, type=float, help='balance factor for contrast loss')
    parser.add_argument('--gamma', default=0.4, type=float, help='edge loss convex weight')
    ...
    parser.add_argument('--pin_memory', default=True, type=_str2bool,
                        help='whether to pin CPU memory in DataLoader (true/false)')
    parser.add_argument('--persistent_workers', default=False, type=_str2bool,

...
if __name__ == '__main__':
    ...
    model = torch.load('logs/model_SFEARNet_data_WHU-CD_lr_0.0001_bs_8_wd_0.001_lam_1.0_ep_100_seed_0/run_2026-04-06_15-31-55/best_model/best_model.pth').to(device)

...
MODEL_NAME="SFEARNet_modified_wo_bounded_diag"
...
USE_BOUNDED_OBJECTIVE=false

RESULT_DIR="./CLCD_result_modified_wo_bounded_diag/"
...
echo "Starting diagnostic repro run without bounded objective"
...
echo "Diagnostic experiment is running in background."
